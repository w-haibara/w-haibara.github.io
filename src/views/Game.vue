  ...
  export default {
    ...
    methods: {
      moveBall: function(x_diff, y_diff){
        ...
        this.ball_x = (this.ball_x_dir)? this.ball_x + x_diff: this.ball_x - x_diff

        if(this.ball_y <= 0 || this.ball_y >= this.vb_height || (this.ball_x >= this.player_x && this.ball_x <= this.player_x + this.player_widht && this.ball_y >= this.player_y)){
          this.ball_y_dir = !this.ball_y_dir
        }
        this.ball_y = (this.ball_y_dir)? this.ball_y + y_diff: this.ball_y - y_diff
